...
local nvim_tree = function() return not not string.match(vim.fn.expand('%:t'), 'NvimTree') end
local check_git_workspace = function()
  local filepath = vim.fn.expand('%:p:h')
  local gitdir = vim.fn.finddir('.git', filepath .. ';')
  return gitdir and #gitdir > 0 and #gitdir < #filepath
end
local hide_in_width = function() return vim.fn.winwidth(0) > 60 end

local conditions = {
  show_filesize = function() return buffer_not_empty() end,
  show_branch = function() return nvim_tree() and check_git_workspace() end,
  show_filename = function() return buffer_not_empty() and not nvim_tree() end,
  show_encoding = function() return not nvim_tree() and hide_in_width() end,
  show_diff = function() return hide_in_width() end,
  show_fileformat = function() return hide_in_width() end,
  show_lsp = function() return not nvim_tree() end,
  show_location = function() return not nvim_tree() end,
  show_progress = function() return not nvim_tree() end,
  show_vim_mode = function() return not nvim_tree() end,
}
